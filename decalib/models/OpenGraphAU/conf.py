...
parser.add_argument('--resume', default='/mnt/hdd/EncoderTrainingCode/Code/decalib/models/OpenGraphAU/checkpoints/OpenGprahAU-ResNet50_second_stage.pth', type=str, metavar='path', help='path to latest checkpoint (default: none)')
...
def get_config():
    ...
    if cfg.dataset == 'BP4D':
        ...
        with open('/mnt/hdd/EncoderTrainingCode/Code/decalib/models/OpenGraphAU/config/hybrid_config.yaml', 'r') as f:
