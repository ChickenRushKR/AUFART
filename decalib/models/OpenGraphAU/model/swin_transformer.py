...
models_dir = os.path.expanduser('/mnt/hdd/EncoderTrainingCode/Code/decalib/models/OpenGraphAU/checkpoints')
model_name = {
    'swin_transformer_tiny': 'OpenGprahAU-SwinT_second_stage.pth',
