    ...
    for line in lines:
        ...
        for i in tqdm(range(len(testdata))):
            ...
            #     opdict_deca, visdict_deca = gate.decode_deca(codedict_deca, use_detail=args.useDetail) #tensor
                emoca_image_path = os.path.join('/mnt/hdd/emoca/DISFA01/',pathname,'rendered_image', name+'00.png')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--savefolder', default='videoResult/emoca_DISFA/', type=str,
