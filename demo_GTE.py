...
def main(args):
    ...
    for i in tqdm(range(len(testdata))):
        ...
        with torch.no_grad():
            codedict  = deca.encode(images_224, use_detail=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--savefolder', default='videoResult/testGTE1/', type=str,
                        help='path to the output directory, where results(obj, txt files) will be stored.')
    # parser.add_argument('--videoName', default='resultWithoutTC.avi', type=str,)
    parser.add_argument('--pretrained_modelpath', default='/mnt/hdd/EncoderTrainingCode/Code/Training/testGTE1/model.tar', type=str, help='model.tar path')
